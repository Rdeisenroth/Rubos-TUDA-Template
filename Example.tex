...
\begin{task}[points=0]{Punktetabellen (WIP)}
    ...
    \begin{table}[ht]
        ...
        \begin{tabularx}{\textwidth}{|X|c|c|}
            ...
            \midrule\midrule
            \mapTasks{%
            \textbf{\taskformat{}}: \currentname  & \getPoints{\thetask}                 & \IfSubtasksTF{\mapSubtasks{ \\%
            \rowcolor{\thepagecolor}\thesubtask{} & \getSubPoints{\thetask}{\thesubtask} &
                    }
            }{}                                                                                                        \\
                \midrule\midrule
            }
            \textbf{Gesamt}                       & \textbf{\getPointsTotal{}}           & \textbf{}                   \\
            \bottomrule
        \end{tabularx}
